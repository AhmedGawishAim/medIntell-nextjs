        ...
        <div className="hero-content h-full grid grid-cols-1 md:grid-cols-2 items-center gap-8">
          <div className="box-left md:py-[160px] py-[20px] ">
            <motion.h1
              ...
              className="text-3xl md:text-5xl font-bold mb-4 leading-[60px]"
            >
            ...
            <div className="flex items-center bg-white shadow-md rounded-[10px] px-4 py-2 max-w-md mx-auto md:mx-0">
              ...
              />
              <a href="#" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-[5px] ml-2 cursor-pointer">
          ...
          <div className="box-right  h-full order-[-5] md:order-1">
            ...
            >
              <Image
                ...
                height={700}
                priority
                className="w-full !h-[100%] mx-auto rounded-xl "
              />
            </motion.div>
          </div>
        </div>
